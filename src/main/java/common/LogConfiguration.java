...
//		    final String logFilePath  = "./test-output/log/"+founctionName+"/"+fileName+".log";
        ...
        prop.setProperty("log4j.appender.toConsole.layout.ConversionPattern","[%d{yyyy-MM-dd HH:mm:ss}] [%p] [%l] %m%n");
        ...
        prop.setProperty("log4j.appender.toFile.layout.ConversionPattern", "[%d{yyyy-MM-dd HH:mm:ss}] [%p] [%l] %m%n");
        //使配置生效
